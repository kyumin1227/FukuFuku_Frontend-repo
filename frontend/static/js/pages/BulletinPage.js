            ...
            <div class="row g-5 block_post">
                ...
                <div class="col-md-4">
                    <a href="/" class="text-decoration-none text-dark">
                        <div class="card" style="height: 470px">
                            <div id="carousel-1" class="carousel slide card-img-top" data-bs-ride="true"
                                style="height: 300px;">
                ...
                <div class="modal-body">
                    <div class="container-fluid">
                            ...
                            <div class="col-4 d-flex justify-content-center" style="overflow-y: auto; height: 65vh;">
                                ...
                                <div id="block_comment" class="col-11">
                                    ...
                                    <div class="row border mt-3 p-1">
                                        ...
                                        <div class="row mt-1">
                                            <div class="col-12">Lorem ipsum dolor sit, amet consectetur adipisicing
                                                elit. Sed tempora eos natus quidem earum iure hic ipsam libero eius
                                                repellat. Laudantium ipsa facere dolor adipisci perspiciatis, voluptatem
                                                et amet? Nostrum.</div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row border mt-3 p-1">
                                        ...
                                        <div class="row mt-1">
                                            <div class="col-12">Lorem ipsum dolor sit, amet consectetur adipisicing
                                                elit. Sed tempora eos natus quidem earum
                                                iure hic ipsam libero eius repellat. Laudantium ipsa facere dolor
                                                adipisci perspiciatis, voluptatem et amet?
                                                Nostrum.</div>
                                        </div>
                                    </div>
                                    <div class="row border mt-3 p-1">
                        ...
                        <div class="row">
                            ...
                            <div class="col-8 bg-secondary bg-opacity-50 p-3 rounded-1 d-flex justify-content-between flex-column"
                                style="height: 15vh;">
