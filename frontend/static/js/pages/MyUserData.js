      ...
      <div class="row" style="height: 500px;">
        ...
        <div class="col-2 bd-sidebar border-top border-bottom border-primary me-5 fw-semibold text-center" >
          <ul class="nav pt-3 flex-column">
            <li class="nav-item"><a class="nav-link active link-dark" href="./MyUserData.html">회원정보 수정</a></li>
            <li class="nav-item"><a class="nav-link active link-dark" href="./MyWriteList.html">쓴 글 목록</a></li>
            <li class="nav-item"><a class="nav-link active link-dark" href="./UserWithdrawal.html">회원 탈퇴</a></li>
          </ul>
        </div>
